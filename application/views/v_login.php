                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="<?= base_url('login/login_aksi'); ?>">
                                        ...
                                        <a href="<?= base_url('login/register') ?>" class="btn btn-success btn-user btn-block"> Register</a>
                                        <a href="<?= base_url() ?>" class="btn btn-secondary btn-user btn-block"> Evaluasi</a>
